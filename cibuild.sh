...
ruby publish.rb --no-fix-links --test 'htmlproof ./ --href-ignore /.*example\.com.*/,/https:\/\/github\.com\/myuser\/myrepo/,/.*revolds-whitepaper\.pdf/ --check-html --ignore-script-embeds --check-favicon'
